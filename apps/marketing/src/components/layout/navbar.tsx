    ...
    <nav className={cn("fixed z-10 w-full", isScrolled && "border-b")}>
      <div className="px-28 pt-4">
        <div className="flex h-16 items-center justify-between">
          <Link to="#" className="h-8 w-28" aria-label="Go to home page">
            ...
            <div className="item-center flex gap-8">
              {navigationLinks.map((link) => (
                ...
                >
                  <Link
                    to={link.href}
                    className="py-1 font-medium text-neutral-600 hover:border-b-2"
                  >
                    {link.title}
                  </Link>
                </button>
          ...
          <div className="hidden gap-4 lg:flex">
            <button className="border-1 rounded border-neutral-200 bg-white px-4 py-2 font-medium text-black shadow-md">
              Learn more
            </button>
            <button className="rounded bg-indigo-700 px-4 py-2 font-medium text-white">
              See Pricing
            </button>
          </div>
          ...
          {isMobileMenuOpen && (
            <div className="absolute left-0 top-16 z-10 w-full bg-white shadow lg:hidden">
